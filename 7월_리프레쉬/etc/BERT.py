...
input_ids > 문장을 토크나이즈 해서 인덱스 값으로 변환하여 사용
attention_mask > 1:어텐션에 영향받는 토큰, 0: 영향없는 토큰
token_type_ids > 두개의 문장 들어갈때 0과 1로 문장의 토큰값 분리.  
"""
...
output = model(x=input['input_ids'], seg=input['token_type_ids'],mask=input['attention_mask'] )
print(output)
