...
model_save_path = "save_model/100실험/"

#저장될 최종 데이터셋 경로 설정
dataset_path = "dataset/100실험"
...
da_all_csv_path = "../소량데이터로 테스트함/데이터셋/점수판별실험전/DA_(0517)t5base, trainData_100, nucleus_sampling, data_10000.csv"
