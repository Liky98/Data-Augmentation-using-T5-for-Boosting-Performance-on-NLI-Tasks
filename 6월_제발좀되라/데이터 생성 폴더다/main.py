...
# 연관 데이터셋 제작
entailment_file_name = "(0620)ALL 연관"
neutral_file_name = "(0620)ALL 모호"
contradiction_file_name = "(0620)ALL 모순"
data_save_path = "(0620)ALL"
...
#dataset_after = s_score.cos_simiraty(dataset_before,"0620ALL")
